...
public class ReviewJpaTest {
    ...
    public static WebArchive deploy() {
        ...
        final WebArchive webArchive = ShrinkWrap.create(WebArchive.class, "test.war")
                ...
                .addAsResource("feed_database.sql")
    ...
    @Inject
    private ReviewJpaController rjc;
    ...
    public void find_all_reviews() throws SQLException {
        List<Review> lr = rjc.findReviewEntities();
        //System.out.println("Data>>>" + lr.get(0).getMedicationList().get(0).getMed());
        assertThat(lr).hasSize(0);
        //assertTrue("Test always True");
    }
