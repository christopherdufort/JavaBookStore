...
@NamedQueries({
    ...
    @NamedQuery(name = "Book.findAllAvailable", query = "SELECT b FROM Book b AND b.getAvailaible = True"),
    @NamedQuery(name = "Book.findByBookIdAvailable", query = "SELECT b FROM Book b WHERE b.bookId = :bookId  AND b.getAvailaible = True"),
    @NamedQuery(name = "Book.findByIsbnAvailable", query = "SELECT b FROM Book b WHERE b.isbn = :isbn  AND b.getAvailaible = True"),
    @NamedQuery(name = "Book.findByTitleAvailable", query = "SELECT b FROM Book b WHERE b.title LIKE :title  AND b.getAvailaible = True"),
    @NamedQuery(name = "Book.findByPublisherAvailable", query = "SELECT b FROM Book b WHERE b.publisher LIKE :publisher  AND b.getAvailaible = True"),
    @NamedQuery(name = "Book.findByFormatAvailable", query = "SELECT b FROM Book b WHERE EXISTS( SELECT 1 FROM b.formatList f WHERE f.formatId = :formatId ) AND b.getAvailaible = 1"),
