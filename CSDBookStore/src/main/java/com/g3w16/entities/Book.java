...
@NamedQueries({
    ...
    @NamedQuery(name = "Book.findByTitleAvailable", query = "SELECT b FROM Book b WHERE b.title LIKE :title  AND b.availaible = 1"),
    @NamedQuery(name = "Book.findByPublisherAvailable", query = "SELECT b FROM Book b WHERE b.publisher LIKE :publisher  AND b.availaible = 1"),
